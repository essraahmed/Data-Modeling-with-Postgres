...
# CREATE TABLES
songplay_table_create = ("""CREATE TABLE IF NOT EXISTS song_plays (songplay_id SERIAL PRIMARY KEY, 
...
songplay_table_insert = ("""INSERT INTO song_plays(start_time, user_id, level, song_id, artist_id,
...
song_select = ("""SELECT s.song_id, s.artist_id
                  FROM songs s INNER JOIN artists a ON \
